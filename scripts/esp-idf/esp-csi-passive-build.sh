...
copy_sdkconfig_template() {
    local template="${PROJECT_ROOT}/templates/esp32-csi-toolkit/passive/sdkconfig.defaults"
...
apply_toolkit_overlay() {
    ...
    local files=(
        ...
        "passive/sdkconfig.defaults"
        "passive/main/main.cc"
        "passive/main/Kconfig.projbuild"
    )
...
main() {
   ...
   # Clone repo if it does not exist
    ...
    cd "third_party/esp32-csi-toolkit/passive" # UDP forwarding requires a real STA connection with an IP
